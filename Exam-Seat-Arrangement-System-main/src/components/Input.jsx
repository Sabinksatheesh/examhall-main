...
export default function Input({ input_id, title, inputRef, type, placeholder }) {
    return (
        <div className="flex flex-col mb-2 md:mr-4">
            ...
            <input id={input_id} ref={inputRef} type={type} className="h-10 px-3 py-2 rounded-[20px] shadow-sm border-gray-300 focus:outline-brown-login" placeholder={placeholder} required />
        </div>
    );
}
