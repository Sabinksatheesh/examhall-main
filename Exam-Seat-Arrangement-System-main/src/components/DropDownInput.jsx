...
export default function DropDownInput({ input_id, title, inputRef, options, isTarget, handleSlot }) {
    ...
    return (
        <div className="flex flex-col mb-2 md:mr-4">
            ...
            <select id={input_id} ref={inputRef} onChange={handleChange} className="h-10 px-3 py-2 rounded-[20px] shadow-sm border-gray-300 min-w-[200px] focus:outline-none focus:ring-2 focus:ring-brown-login">
                {options.map(item => (
